...
NetID <- function(work_dir, file_name, ion_mode, decoy_lib) {
    ...
    read_files = function(
        ...
        ion_mode = -1,
        neg_MS2_library_file = "../HMDB_pred_MS2_neg.rds",
        pos_MS2_library_file = "../HMDB_pred_MS2_pos.rds",
        HMDB_library_file = "../hmdb_library.csv",
        known_library_file = "../known_library.csv",
        LC_method = "Hilic_25min_QE",
        empirical_rule_file = "../empirical_rules.csv",
        propagation_rule_file = "../propagation_rule.csv",
    ...
    # Run optimization ####
    {
        ...
        save(CplexSet,StructureSet_df,LibrarySet,
